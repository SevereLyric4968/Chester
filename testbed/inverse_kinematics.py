...
class poseIK:
    ...
    def calculateIK(self, x, y, z, roll, pitch, yaw):
        ...
        self.robot.move_joints(motorOneAngle, motorTwoAngle, motorThreeAngle, motorFourAngle, motorFiveAngle, motorSixAngle)
...
if __name__ == "__main__":
    ...
    IK.calculateIK(0.2832, 0.0393, 0.11, 0, np.pi/2, 0)
